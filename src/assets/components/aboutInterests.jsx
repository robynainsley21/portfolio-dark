      ...
      <div className="mt-5 space-y-1.5 px-5 pb-10">
        ...
        <p className="ml-3 font-mono text-xs font-normal tracking-wide text-violet-400">
          ...
          <p className="ml-4 font-mono text-xs font-normal tracking-wide text-violet-400">
            ...
            <span className="relative inline-block px-1 before:absolute before:block before:rounded before:bg-blue-500/10">
              <span className="relative text-blue-400">
                Being organized and observant are skills of mine, combined with
                the ability to adapt to my environment.
              </span>
            </span>
            <span className="text-slate-500">&lt;/</span>
            <span className="text-pink-400">Text</span>
        ...
        <p className="ml-3 font-mono text-xs font-normal leading-4 tracking-wide text-violet-400">
          ...
          <span className="relative inline-block px-1 before:absolute before:block before:rounded before:bg-blue-500/10">
            <span className="relative text-blue-400">
              In my free time, I enjoy reading books on self-improvement and
        ...
        <p className="ml-3 font-mono text-xs font-normal tracking-wide text-violet-400">
          <span className="text-slate-500">&lt;</span>
          <span className="text-pink-400">Aspirations</span>
        ...
        <p className="ml-6 font-mono text-xs font-normal tracking-wide text-violet-400">
          ...
          <span className="text-pink-400">Text</span>
          <span className="text-slate-500">&gt;</span>
          <span className="text-blue-400"> Become a</span>
          <span className="text-slate-500">&lt;</span>
          <span className="text-pink-400">Bold</span>
          <span className="text-slate-500">&gt;</span>
          <span className="relative inline-block px-1 before:absolute before:block before:rounded before:bg-blue-500/10">
            <span className="relative text-green-400">software engineer.</span>
          </span>
          <span className="text-slate-500">&lt;/</span>
          <span className="text-pink-400">Bold</span>
          <span className="text-slate-500">&gt;</span>
        ...
        <p className="ml-6 font-mono text-xs font-normal tracking-wide text-violet-400">
          ...
          <span className="relative inline-block px-1 before:absolute before:block before:rounded before:bg-blue-500/10">
            <span className="relative text-blue-400">
              ...
              <span className="text-slate-500">&gt;</span>
              <span className="relative inline-block px-1 before:absolute before:block before:rounded before:bg-blue-500/10">
                <span className="relative text-green-400">brand.</span>
              </span>
              <span className="text-slate-500">&lt;/</span>
              <span className="text-pink-400">Bold</span>
              <span className="text-slate-500">&gt;</span>
